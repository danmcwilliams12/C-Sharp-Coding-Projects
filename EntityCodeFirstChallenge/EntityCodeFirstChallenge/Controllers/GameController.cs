...
using EntityCodeFirstChallenge.DAL;
...
namespace EntityCodeFirstChallenge.Controllers
{
    public class GameController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Designer,PlayTime,CoreMechanic,MinPlayers,MaxPlayers,Weight,Rating")] Game game)
        {
            if (ModelState.IsValid)
            {
